...
<head>
    ...
    <meta content="Data tambahan skin mlbb" name="keywords">
    <meta content="Download data tambahan skin mlbb terpisah untuk pengguna mlbb lite" name="description">
    ...
    <link href="https://fo-rpl.github.io/javascript.cdn-versi1.2/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="https://fo-rpl.github.io/javascript.cdn-versi1.2/css/style.css" rel="stylesheet">
</head>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="pb-3">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="https://fo-rpl.github.io/gambar/github1-min-696x391.png" alt="">
                    ...
                    <div class="bg-secondary mb-3" style="padding: 30px;">
                        ...
                        <h4 class="font-weight-bold mb-3">'.$judul.'</h4>
                        <p>
                        '.$data.'
                        </p>
                    </div>
                ...
                <div class="bg-secondary mb-3" style="padding: 30px;">
                    ...
                    <form>
                        ...
                        <div class="form-group mb-0">
                            <input onclick="alert("Halaman ini tidak mendukung komantar")" type="button" value="Leave a comment"
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                ...
                <!-- Plain Text Start -->
                <div>
                    <h3 class="mb-4">My Quotes</h3>
                    <div class="bg-secondary text-center" style="padding: 30px;">
                        <p>Aku memilih menjadi seorang gamer karena tidak ada hal epik yang pernah terjadi dalam kehidupan nyata.</p>
