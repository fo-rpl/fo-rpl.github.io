...
<form id="editor" class="form-user" action="create.php" method="post">
 ...
 <div class="aktif"></div>
          <textarea style="background:transparent;height:180px;width:90%;opacity:0.5;color:red" readonly="readonly" type="text" id="data1" name="data"></textarea>
<br>
         &nbsp;nama file =<input style="background:transparent" type="text" id="jfile" name="jfile" value="<?php
echo $draft[0]['jfile'];
?>"><br>
         &nbsp;judul hal &nbsp;=<input style="background:transparent" type="text" id="judulf" name="jdul" value="<?php
echo $draft[0]['judul'];
?>"><br>
       <input type="submit" style="" onclick="alert('fungsi simpan ini hanya untuk menympan dalam bentuk file, halaman ini tidak akan meninggalkan jejak, pastikan projek kamu telah selesai, kamu bisa minympan text di hp mu jika ingin melanjutkan nanti')" value="simpan">
...
document.getElementById('jfile').addEventListener('keyup',
name = this.value
)
document.getElementById('judulf').addEventListener('keyup',
function (){judul = this.value}
)
